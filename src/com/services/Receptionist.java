...
public void createGui()
{
	...
	txtreceptionistidadd.setEditable(true);
...
public void actionPerformed(ActionEvent e) {
	...
	public void jListDemo()
	{
		...
		String item="";
		String strsql= "Select ServiceId from Service_Task";
		try {
			pslist=conn.prepareStatement(strsql);
			rslist=pslist.executeQuery();
			while(rslist.next())
			{
				item+=":"+rslist.getString("ServiceId");
			}
			...
			JButton refreshServiceIds = new JButton("Refresh");
			refreshServiceIds.setBounds(443, 126, 83, 15);
			refreshServiceIds.addActionListener(this);
			
			panel.add(refreshServiceIds);
		  ...
		  for(int i = 0; i < a.length; i++)
		    {
			  ...
			  String copy=txtserviceidadd.getText()+":"+serType;
			  txtserviceidadd.setText(copy);
