...
public class EnggManageService extends JFrame implements ActionListener{
	...
	void createGui()
	{
		...
		txtrequestidupd.setEnabled(false);
		txtrequestidupd.setEditable(false);
    ...
    //	 String deliverystatus = txtdeliverystatusupd.getText();
	 ...
	 public void Search()
	    {
	    	String id=txtvehiclenumupd.getText();
	    	if(id.isEmpty())
			{
			...
			JOptionPane.showMessageDialog(this, "NO SUCH Vehicle Number","Searching",JOptionPane.QUESTION_MESSAGE);
